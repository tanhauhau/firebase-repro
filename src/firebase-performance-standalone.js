// https://www.gstatic.com/firebasejs/7.24.0/firebase-performance-standalone.js
!(function (e, t) {
  ...
  function d(e, t) {
    ...
    for (var n in t) t.hasOwnProperty(n) && (e[n] = d(e[n], t[n]));
    return e;
  }
  var o =
  ...
  function G(c) {
    var u = {},
      ...
      f = {
        ...
        initializeApp: function (e, t) {
          ...
          if (_(u, t)) throw F.create('duplicate-app', { appName: t });
          n = new c(e, n, f);
          return (u[t] = n);
        },
        app: p,
    ...
    function p(e) {
      if (!_(u, (e = e || V))) throw F.create('no-app', { appName: e });
      return u[e];
    }
    function o(n) {
      var t,
    ...
    return u(this, void 0, void 0, function () {
      ...
      return l(this, function (e) {
        switch (e.label) {
          ...
          case 4:
            return e.sent(), (i && i.fid === a.fid) || Re(o, a.fid), [2, a];
        }
      });
    });
  }
    ...
    return u(this, void 0, void 0, function () {
      ...
      return l(this, function (e) {
        switch (e.label) {
          ...
          case 7:
            return (
              e.sent(), !o || (i && i.fid === o.fid) || Re(a, o.fid), [2, o]
            );
        }
      });
    });
                        ...
                        return u(this, void 0, void 0, function () {
                          ...
                          return l(this, function (e) {
                            switch (e.label) {
                              ...
                              case 3:
                                return !be((n = e.sent())) ||
                                  (401 !== n.serverCode && 404 !== n.serverCode)
                                  ? [3, 5]
                                  : [4, Ke(i.appConfig)];
                              case 4:
                                return e.sent(), [3, 7];
  ...
  (Be = X).INTERNAL.registerComponent(
    ...
    Be.registerVersion('@firebase/installations', '0.4.17');
  var rt,
    it,
    ot = '0.4.2',
  ...
  (nn = X).INTERNAL.registerComponent(
    ...
    nn.registerVersion('@firebase/performance', '0.4.2');
  return X.registerVersion('firebase', '7.24.0', 'lite'), X;
});
